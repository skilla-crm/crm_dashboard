        ...
        <div className={s.root}>
            <ThemeProvider theme={theme}>
                ...
                >
                    ...
                    >
                        {financeGrid?.filter(el => el.type_block === 3)?.slice(0, numberSmallBlock)?.map(el =>
                            <Grid
                                item
                                size={6}
                            >
                    ...
                    >
                        {financeGrid?.filter(el => el.type_block === 2)?.map(el =>
                            <Grid
                                item
                                size={12}
                            >
                        ...
                        >
                            {financeGrid?.filter(el => el.type_block === 3)?.slice(numberSmallBlock, 20)?.map(el =>
                                <Grid
                                    item
                                    size={6}
                                >
