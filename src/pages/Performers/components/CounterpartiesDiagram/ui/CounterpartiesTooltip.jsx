import s from './CounterpartiesTooltip.module.scss';
...
/**
 * Рендер тултипа для графиков контрагентов.
 * @param {Object} props
 ...
 * @param {(value: number) => string} [props.valueFormatter=formatValue] Форматтер числовых значений.
 */
const CounterpartiesTooltip = ({
    active,
    payload,
    label,
    seriesLabels = {},
...
export default CounterpartiesTooltip;
