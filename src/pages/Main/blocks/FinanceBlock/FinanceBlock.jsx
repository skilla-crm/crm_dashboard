                    ...
                    <Grid container spacing={3} item size={8}>
                        ...
                        <Grid item size={6}>
                            <Indicator
                                ...
                                increaseView={true}
                                increase={
                                    financeData?.operating_profit?.increase || 0
                                }
                                prevPeriod={getDatePeriodShort(datePeriod)}
                                info={null}
                                reverse={true}
                        ...
                        <Grid item size={6}>
                            <Indicator
                                ...
                                indicator={
                                    financeData?.lost_revenue?.indicator || 0
                                }
                                increaseView={true}
                                increase={
                                    financeData?.lost_revenue?.increase || 0
                                }
                                prevPeriod={getDatePeriodShort(datePeriod)}
                                info={null}
                                reverse={false}
                    ...
                    <Grid container spacing={3} size={4}>
                        <Grid item size={12}>
                            <Indicator
                                ...
                                increaseView={true}
                                increase={
                                    financeData?.orders_sum_beznal?.increase ||
                                    0
                                }
                                prevPeriod={getDatePeriodShort(datePeriod)}
                                info={null}
                        ...
                        <Grid item size={12}>
                            <Indicator
                                ...
                                indicator={
                                    financeData?.transactions_income
                                        ?.indicator || 0
                                }
                                increaseView={true}
