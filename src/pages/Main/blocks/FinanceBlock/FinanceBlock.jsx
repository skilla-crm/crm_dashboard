...
const FinanceBlock = ({ data, isLoading, datePeriod, error, refetch }) => {
    const buttonAddBankAccountConfig = {
        ...
        onButtonClick: () => {
            window.open(
                'https://lk.skilla.ru/new/bank?section=detail',
                '_blank'
            );
        },
                        ...
                        >
                            ...
                            >
                                <IndicatorWithChart
                                    ...
                                    prevPeriodIndicator={
                                        data?.revenue?.prev_period_indicator ||
                                        0
                                    }
                            ...
                            >
                                ...
                                >
                                    <Indicator
                                        ...
                                        increaseView={true}
                                        increase={
                                            data?.marginal_profit?.increase || 0
                                        }
                                ...
                                >
                                    <Indicator
                                        ...
                                        indicator={
                                            data?.costs_total?.indicator || 0
                                        }
                                        increaseView={true}
                                        increase={
                                            data?.costs_total?.increase || 0
                                        }
                                        prevPeriod={getDatePeriodShort(
                                            datePeriod
                                        )}
                                ...
                                >
                                    <Indicator
                                        ...
                                        increaseView={true}
                                        increase={
                                            data?.operating_profit?.increase ||
                                            0
                                        }
                                        prevPeriod={getDatePeriodShort(
                                            datePeriod
                                ...
                                >
                                    <Indicator
                                        ...
                                        indicator={
                                            data?.lost_revenue?.indicator || 0
                                        }
                                        increaseView={true}
                                        increase={
                                            data?.lost_revenue?.increase || 0
                                        }
                                        prevPeriod={getDatePeriodShort(
                                            datePeriod
                                        )}
