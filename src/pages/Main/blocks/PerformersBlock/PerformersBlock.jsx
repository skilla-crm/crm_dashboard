                    ...
                    <Grid container spacing={3} item size={6}>
                        <Grid item size={6}>
                            <Indicator
                                ...
                                indicator={
                                    performersData?.invitations?.indicator || 0
                                }
                                increaseView={true}
                                increase={
                                    performersData?.invitations?.increase || 0
                                }
                                prevPeriod={getDatePeriodShort(datePeriod)}
                                info={null}
                                reverse={false}
                        ...
                        <Grid item size={6}>
                            <Indicator
                                ...
                                indicator={
                                    performersData?.registered?.indicator || 0
                                }
                                increaseView={true}
                                increase={
                                    performersData?.registered?.increase || 0
                                }
                                prevPeriod={getDatePeriodShort(datePeriod)}
                                info={null}
                                reverse={false}
                        ...
                        <Grid item size={6}>
                            <Indicator
                                ...
                                indicator={
                                    performersData?.first_order?.indicator || 0
                                }
                                increaseView={true}
                                increase={
                                    performersData?.first_order?.increase || 0
                                }
                                prevPeriod={getDatePeriodShort(datePeriod)}
                                info={null}
                                reverse={false}
                        ...
                        <Grid item size={6}>
                            <Indicator
                                title={'На заказах'}
                                indicator={
                                    performersData?.in_orders?.indicator || 0
                                }
                                increaseView={true}
                                increase={
                                    performersData?.in_orders?.increase || 0
                                }
                                prevPeriod={getDatePeriodShort(datePeriod)}
                                info={null}
                                reverse={false}
